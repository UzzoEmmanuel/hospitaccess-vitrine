...
import {
  ...
  advantagesContent,
  callToActionContent,
} from '../../locales/content/service-whiteLabel-onlineAdmission/service-whiteLabel-onlineAdmission.content';
import { contactUsContent } from '../../locales/content/common/contactUs.content';

const ServiceOnlineAdmissionWhiteLabel = () => {
...
export default ServiceOnlineAdmissionWhiteLabel;
