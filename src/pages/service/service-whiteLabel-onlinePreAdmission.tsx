...
import {
  ...
  advantagesContent,
  callToActionContent,
} from '../../locales/content/service-whiteLabel-onlinePreAdmission/service-whiteLabel-onlinePreAdmisision.content';
import { contactUsContent } from '../../locales/content/common/contactUs.content';

const ServiceOnlinePreAdmissionWhiteLabel = () => {
...
export default ServiceOnlinePreAdmissionWhiteLabel;
